...
const BaselineDataController = () => import('#controllers/baseline_data_controller')
const TargetBehaviorController = () => import('#controllers/target_behavior_controller')
 ...
 // LiveAvatar routes (public)
  ...
  router.group(() => {
    ...
    router.group(() => {
      ...
      // Baseline Data (role-based access)
      router.get('/baseline-data', [BaselineDataController, 'index'])
      router.post('/baseline-data', [BaselineDataController, 'store'])
      router.put('/baseline-data/:id', [BaselineDataController, 'update'])
      router.delete('/baseline-data/:id', [BaselineDataController, 'destroy'])
      router.get('/baseline-data/summary', [BaselineDataController, 'summary'])
      
      // Target Behaviors (role-based access)
      router.get('/target-behaviors', [TargetBehaviorController, 'index'])
      router.post('/target-behaviors', [TargetBehaviorController, 'store'])
      router.post('/target-behaviors/bulk', [TargetBehaviorController, 'bulkStore'])
      router.put('/target-behaviors/:id', [TargetBehaviorController, 'update'])
      router.delete('/target-behaviors/:id', [TargetBehaviorController, 'destroy'])
      router.get('/target-behaviors/statistics', [TargetBehaviorController, 'statistics'])
